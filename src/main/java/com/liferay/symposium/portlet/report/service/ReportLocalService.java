...
public interface ReportLocalService extends BaseLocalService,
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ReportLocalServiceUtil} to access the report local service. Add custom service methods to {@link com.liferay.symposium.portlet.report.service.impl.ReportLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
    ...
    */
    ...
    public com.liferay.symposium.portlet.report.model.Report addReport(
    ...
    */
    public com.liferay.symposium.portlet.report.model.Report createReport(
        long reportId);
    ...
    */
    ...
    public com.liferay.symposium.portlet.report.model.Report deleteReport(
        long reportId)
    ...
    */
    ...
    public com.liferay.symposium.portlet.report.model.Report fetchReport(
        long reportId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.liferay.symposium.portlet.report.model.Report fetchReportByUuidAndCompanyId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.liferay.symposium.portlet.report.model.Report fetchReportByUuidAndGroupId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.liferay.symposium.portlet.report.model.Report getReport(
        long reportId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.liferay.symposium.portlet.report.model.Report getReportByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.liferay.symposium.portlet.report.model.Report getReportByUuidAndGroupId(
        java.lang.String uuid, long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<com.liferay.symposium.portlet.report.model.Report> getReports(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
    public com.liferay.symposium.portlet.report.model.Report updateReport(
        com.liferay.symposium.portlet.report.model.Report report)
        throws com.liferay.portal.kernel.exception.SystemException;
